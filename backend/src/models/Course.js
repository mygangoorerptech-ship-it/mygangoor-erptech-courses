...
const CourseSchema = new mongoose.Schema({
  ...
  // NOTE: Global courses are determined by NO CourseAssignment entries (not orgId=null)
...
// Prevent duplicate course titles within the same org (case-insensitive, strength:2)
// sparse:true excludes global courses (orgId:null) from uniqueness enforcement
CourseSchema.index(
  { orgId: 1, title: 1 },

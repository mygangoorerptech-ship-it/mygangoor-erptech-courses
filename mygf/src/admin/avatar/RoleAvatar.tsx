...
type Role = 'superadmin'|'admin'|'vendor'|'student'|'orgadmin'|'orguser';
...
export default function RoleAvatar({ role, size = 36 }: { role: Role; size?: number }) {
  ...
  const map: Record<Role, { className: string; Icon: any; label: string }> = {
    ...
    vendor:     { className: 'bg-gradient-to-br from-amber-500 to-orange-500 text-white',Icon: Briefcase, label: 'VE' },

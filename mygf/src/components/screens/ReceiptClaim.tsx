...
export default function ReceiptClaim() {
  ...
  return (
    <div className="max-w-xl mx-auto p-6 space-y-4">
      ...
      <p className="text-sm text-black">If you paid at the office via UPI/GPay, submit your receipt/UTR here. Your organization will verify it and unlock your course.</p>

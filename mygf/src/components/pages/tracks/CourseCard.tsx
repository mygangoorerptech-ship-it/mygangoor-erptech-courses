  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-4">
        ...
        {course.track && <p className="text-xs uppercase tracking-wider text-black">{course.track}</p>}
        ...
        <div className="mt-2 flex items-center justify-between">
          <div className="flex items-center gap-1 text-sm text-black">
            ...
            {typeof course.ratingCount === "number" && <span className="text-xs text-black">({course.ratingCount})</span>}
          </div>
          <span className="px-2 py-1 text-xs text-black border border-slate-300">{course.level}</span>
        </div>
        ...
        <div className="mt-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <button
              className="border border-slate-300 px-3 py-2 text-xs font-medium text-black hover:bg-slate-50 focus-visible:ring-2 focus-visible:ring-slate-300 focus-visible:ring-offset-2"
          ...
          <span className="text-xs text-black">{course.durationHours}h</span>
        </div>
      </div>
